<div class="">
    ...
    <div class="table-wrapper">
        <div class="table-title">
            <div class="row">
                <div class="col-sm-6">
                    <h2>Gestionar <b>Transacciones</b></h2>
                </div>
                <div class="col-sm-6">
            ...
            <tbody>
                ...
                /*foreach ($selled as $s) : ?>
                    <tr>
                        ...
                        <td>---</td>
                        <td>
                            <a href="#editUserModal<?php echo $s->_id; ?>" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Editar">&#xE254;</i></a>
                            <a href="#deleteUserModal<?php echo $s->_id; ?>" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Eliminar">&#xE872;</i></a>
                        </td>
                    </tr>
                    <!-- Edit Modal HTML -->
                    <div id="editUserModal<?php echo $s->_id; ?>" class="modal fade">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form action="<?php echo base_url() . 'dashboard/list-users-edit' ?>" method="post">
                                    <input type="hidden" name="id_user" value="<?php echo $s->_id; ?>" required>
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <label>nombre*</label>
                                            <input name="name" type="text" class="form-control" value="<?php echo $s->nombre; ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Apellidos*</label>
                                            <input name="last_name" type="text" class="form-control" value="<?php echo $s->apellido; ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Correo Electronico*</label>
                                            <input name="email" type="email" class="form-control" value="<?php echo $s->correo; ?>" required>
                                        </div>
                                    </div>
                    ...
                    <!-- Delete Modal HTML -->
                    <div id="deleteUserModal<?php echo $s->_id; ?>" class="modal fade">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form action="<?php echo base_url() . 'dashboard/list-users-delete' ?>" method="post">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <h4 class="modal-title"><?php echo $s->nombre,' ', $s->apellido; ?></h4>
