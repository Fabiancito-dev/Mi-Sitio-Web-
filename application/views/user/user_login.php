                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="form-group">
                            <div class="p-5">
                                ...
                                <form class="user" action="<?php echo base_url() . 'user-login/user-log-verify'; ?>" method="post">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn-primary-user btn-block">Iniciar Sesion</button>
                                    </div>
                                    <hr>
                                    ...
                                    <a class="btn btn-facebook btn-user btn-block" title="En proceso de desarrollo">
                                        <i class="fab fa-facebook-f fa-fw"></i> Inicio de Sesion con Facebook
                                    </a>
                                </form>
                                <hr>
                                <div class="text-center">
                                    <a class="" title="En proceso de desarrollo">¿Contraseña olvidada?</a>
                                </div>
                                <div class="text-center">
                                    <a class="" href="<?php echo base_url() . 'user-registry'; ?>">No tienes una cuenta? Registrate</a>
                                </div>
                            </div>
                        </div>
                    </div>
